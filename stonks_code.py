...
async def parse_company_page(session, url: str, usd_to_rub: Decimal) -> Dict[str, Any]:
    ...
    pe = safe_decimal(pe_tag.find_next("span").text) if pe_tag else Decimal("inf")
    ...
    try:
        ...
        potential_profit = ((week_high - week_low) / week_low) * 100 if week_low and week_high else 0
        ...
        for page in range(1, 3):
            ...
            for row in table_rows:
                ...
                try:
                    ...
                    print(f"⚠️ Ошибка чтения роста компании: '{year_growth_text}'")
                    year_growth = 0
